...
def parse_args():
    ...
    parser.add_argument('--cfg', help='experiment configure file name', type=str,default='experiments/cityscapes/192x192_adam_lr1e-3_wd1e-4_bs_64_epoch9k.yaml')

    parser.add_argument("--local_rank", type=int, default=0)
    parser.add_argument("--stage", type=int, default=2)
    parser.add_argument("--noise", type=float, default=50.0)
    parser.add_argument('--resume_seg1', type=str, default='/media/larry/code/SDABN/test_model/city/50/s.pth')
    ...
    parser.add_argument('--resume_d3', type=str, default='')
...
def main():
    ...
    model_path = [args.resume_seg1,args.resume_d1,args.resume_seg2,args.resume_d2,args.resume_seg3,args.resume_d3]
    ...
    train_dataset = eval('lib.datasets.'+config.DATASET.DATASET)(
                        ...
                        random_crop=config.TRAIN.RAND_CROP,
    ...
    test_dataset = eval('lib.datasets.'+config.DATASET.DATASET)(
                        ...
                        num_classes=config.DATASET.NUM_CLASSES,
                        random_crop=config.TEST.RAND_CROP,
                        flip=False,
                        ignore_label=config.TRAIN.IGNORE_LABEL,
    ...
    for epoch in tqdm(range(last_epoch, end_epoch)):
        ...
        if epoch % 100 == 0:
            np.random.seed(0)
            valid_loss, mean_psnr = validate(config,
            ...
            },os.path.join(final_output_dir, str(epoch)+'_'+str(mean_psnr)+'.pth'))

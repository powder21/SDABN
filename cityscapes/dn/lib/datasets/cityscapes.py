...
class Cityscapes(BaseDataset):
    def __init__(self, 
        ...
        super(Cityscapes, self).__init__(ignore_label, base_size,
                crop_size, downsample_rate, scale_factor, mean, std, noise_level)
        ...
        self.label_mapping = {-1: ignore_label, 0: ignore_label, 
                              ...
                              31: 16, 32: 17, 33: 18}
        print(len(self.files),' images have been loaded and noise level is', self.noise_level)
    ...
    def __getitem__(self, index):
        ...
        noisy_image_seg, clean_image = self.gen_sample(image, label,
                                self.random_crop, self.flip,
                                self.center_crop_test)

        return noisy_image_seg.copy(), clean_image.copy(), np.array(size)
